...
public class Marks extends JFrame implements ActionListener {
    ...
    Marks(String rollno){
        ...
        JLabel heading = new JLabel("FR.CRCE College");
        heading.setBounds(100,10,500,25);
        heading.setFont(new Font("Tahoma",Font.BOLD,20));
        add(heading);
        
        JLabel subheading = new JLabel("Result Of Examination 24-25");
        ...
        JLabel lblsemester = new JLabel("Result Of Examination 24-25");
