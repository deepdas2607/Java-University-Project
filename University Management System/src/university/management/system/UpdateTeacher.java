...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    JTextField tfemail,tfaddress,tfphone,tfbranch,tfcourse;
    JLabel labelempid;
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            try{
                String query = "update teacher set address='"+address+"',phone ='"+phone+"',email='"+emailid+"',education='"+course+"',department='"+branch+"' where empid='"+empid+"'";
                Conn con = new Conn();
