...
public class AddTeacher extends JFrame implements ActionListener{
    ...
    AddTeacher(){
        ...
        labelempid = new JLabel("69"+first3);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            try{
                String query = "insert into teacher values('"+name+"','"+fname+"','"+rollno+"','"+dob+"','"+address+"','"+phone+"','"+emailid+"','"+x+"','"+xii+"','"+aadhar+"','"+course+"','"+branch+"')";
                Conn con = new Conn();
                con.s.executeUpdate(query);
                
                JOptionPane.showMessageDialog(null,"Teacher Details Entered Sucessfully");
                setVisible(false);
            } catch(Exception e){
                e.printStackTrace();
            }
